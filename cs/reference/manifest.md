...
description: "Povinné jsou jen id, name a version; entry má výchozí index.js. Deklarujte všechny použité capabilities. Native Mode vyžaduje povolení serveru i workspace."
icon: blocks
---
