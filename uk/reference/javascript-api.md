---
title: "Довідник JavaScript API"
description: "Усі символи доступні глобально та через об’єкт Nexora. Асинхронні операції безпечно повертаються до runtime workspace."
icon: book-open
---
