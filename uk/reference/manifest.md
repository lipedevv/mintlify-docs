---
title: "Маніфест workspace"
description: "Обов’язкові лише id, name і version; entry за замовчуванням index.js. Оголосіть усі використані capabilities. Native Mode потребує дозволу сервера і workspace."
icon: blocks
---
