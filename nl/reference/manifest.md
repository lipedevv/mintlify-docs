...
description: "Alleen id, name en version zijn verplicht; entry is standaard index.js. Declareer elke gebruikte capability. Native Mode vereist toestemming van server en workspace."
icon: blocks
---
