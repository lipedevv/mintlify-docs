---
title: "เอกสารอ้างอิง JavaScript API"
description: "สัญลักษณ์ทั้งหมดใช้ได้ทั้งแบบ global และผ่านออบเจ็กต์ Nexora งาน asynchronous จะกลับสู่ runtime อย่างปลอดภัย"
icon: book-open
---
