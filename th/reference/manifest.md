---
title: "Manifest ของ Workspace"
description: "จำเป็นเฉพาะ id, name และ version; entry เริ่มต้นเป็น index.js ต้องประกาศ capability ที่ใช้ทั้งหมด Native Mode ต้องเปิดทั้งฝั่งเซิร์ฟเวอร์และ Workspace"
icon: blocks
---
