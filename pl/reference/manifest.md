...
description: "Wymagane są tylko id, name i version; domyślny entry to index.js. Zadeklaruj każdą używaną capability. Tryb natywny wymaga zgody serwera i workspace."
icon: blocks
---
