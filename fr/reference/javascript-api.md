...
description: "Tous les symboles sont disponibles globalement et via l’objet Nexora. Les opérations asynchrones reprennent en sécurité dans le runtime du workspace."
icon: book-open
---
