---
title: "Workspace マニフェスト"
description: "必須は id、name、version のみで、entry の既定値は index.js です。使用する capability をすべて宣言してください。Native Mode はサーバーと Workspace の両方の許可が必要です。"
icon: blocks
---
