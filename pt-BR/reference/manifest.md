---
title: "Manifesto do workspace"
description: "Apenas id, name e version são obrigatórios; entry usa index.js por padrão. Declare todas as capacidades usadas. O Modo Nativo exige ativação no servidor e adesão do workspace."
icon: blocks
---
