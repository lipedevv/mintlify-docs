---
title: "بيان مساحة العمل"
description: "الحقول الإلزامية هي id وname وversion فقط؛ والقيمة الافتراضية لـentry هي index.js. أعلن كل capability مستخدمة. يتطلب الوضع الأصلي تفعيل الخادم وموافقة مساحة العمل."
icon: blocks
---
