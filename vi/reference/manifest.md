...
description: "Chỉ id, name và version là bắt buộc; entry mặc định là index.js. Khai báo mọi capability được dùng. Native Mode cần cả máy chủ và workspace cho phép."
icon: blocks
---
