---
title: "Tham chiếu API JavaScript"
description: "Mọi ký hiệu bên dưới có sẵn toàn cục và qua đối tượng Nexora. Tác vụ bất đồng bộ quay lại runtime workspace an toàn."
icon: book-open
---
