---
title: "Referencia de la API JavaScript"
description: "Los símbolos siguientes están disponibles globalmente y mediante el objeto Nexora. Las operaciones asíncronas vuelven de forma segura al runtime del workspace."
icon: book-open
---
