...
description: "Povinné sú iba id, name a version; entry má predvolený index.js. Deklarujte všetky použité capabilities. Native Mode vyžaduje povolenie servera aj workspace."
icon: blocks
---
