---
title: "GUI Shop"
description: "Ограничения: 1–6 рядов сундука, 1–99 предметов, 20 тиков/с, HTTP 100–60000 мс и до 100 SQL-операций в транзакции. В этой версии реализованы только GUI сундука."
icon: shopping-cart
---
