---
title: "Манифест workspace"
description: "Обязательны только id, name и version; entry по умолчанию index.js. Укажите все нужные capabilities. Native Mode требует разрешения сервера и workspace."
icon: blocks
---
