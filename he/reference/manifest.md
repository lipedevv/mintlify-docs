---
title: "מניפסט Workspace"
description: "רק id, name ו-version חובה; ברירת המחדל של entry היא index.js. הצהירו על כל capability בשימוש. Native Mode דורש אישור בשרת וב-Workspace."
icon: blocks
---
