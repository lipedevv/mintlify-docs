...
description: "Hanya id, name, dan version yang wajib; entry default index.js. Nyatakan setiap capability yang dipakai. Native Mode memerlukan izin server dan workspace."
icon: blocks
---
