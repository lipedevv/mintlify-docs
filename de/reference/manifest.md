...
description: "Nur id, name und version sind Pflicht; entry ist standardmäßig index.js. Jede verwendete Capability muss angegeben werden. Native Mode braucht Serverfreigabe und Workspace-Opt-in."
icon: blocks
---
