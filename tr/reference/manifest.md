---
title: "Workspace manifesti"
description: "Yalnızca id, name ve version zorunludur; entry varsayılan olarak index.js olur. Kullanılan tüm yetenekleri bildirin. Native Mode hem sunucu hem workspace onayı ister."
icon: blocks
---
