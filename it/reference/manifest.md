---
title: "Manifest del workspace"
description: "Solo id, name e version sono obbligatori; entry è index.js per impostazione predefinita. Dichiara ogni capability usata. La modalità nativa richiede consenso del server e del…"
icon: blocks
---
