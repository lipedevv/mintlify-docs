...
description: "All symbols below are available as globals and through the Nexora object. Promise-returning storage, database and HTTP operations resume safely through the workspace runtime."
icon: book-open
---
