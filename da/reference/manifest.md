...
description: "Kun id, name og version er påkrævet; entry er som standard index.js. Angiv alle brugte capabilities. Native Mode kræver accept fra både server og workspace."
icon: blocks
---
