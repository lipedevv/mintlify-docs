...
description: "Csak az id, name és version kötelező; az entry alapértéke index.js. Minden használt capability legyen deklarálva. A natív mód szerver- és workspace-engedélyt is igényel."
icon: blocks
---
