...
description: "Endast id, name och version krävs; entry är index.js som standard. Deklarera alla använda capabilities. Native Mode kräver godkännande av både server och workspace."
icon: blocks
---
